...
import mikenakis.assessment.internal.type.exceptions.AnnotatedInvariableArrayFieldMustBePrivateException;
import mikenakis.assessment.internal.type.exceptions.AnnotatedInvariableFieldMayNotAlreadyBeInvariableException;
import mikenakis.assessment.internal.type.exceptions.AnnotatedInvariableFieldMustBePrivateException;
import mikenakis.assessment.internal.type.exceptions.NonArrayFieldMayNotBeAnnotatedInvariableArrayException;
...
import mikenakis.assessment.internal.type.exceptions.VariableFieldMayNotBeAnnotatedInvariableArrayException;
...
public class T10_ObjectAssessor
{
	...
	private static ObjectAssessment assess( ObjectAssessor objectAssessor, Object object )
	{
		System.out.println( "assessment for object " + AssessmentPrinter.stringFromObjectIdentity( object ) + ":" );
		ObjectAssessment assessment;
		try
		{
			assert objectAssessor.mustBeImmutableAssertion( object );
	...
	{
		return assess( ObjectAssessor.instance, object );
	}
