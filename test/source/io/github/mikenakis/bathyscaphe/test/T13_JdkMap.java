...
public class T13_JdkMap
{
	 ...
	 */
	@Test public void map_class_for_zero_entries_is_same_as_for_N_entries()
	{
	 ...
	 */
	@Test public void map_class_for_2_entries_is_same_as_for_N_entries()
	{
	 ...
	 */
	@Test public void map_class_for_N_entries_is_same_no_matter_how_it_is_created()
	{
	...
	@Test public void map_of_size_0_is_immutable()
	{
	...
	@Test public void map_of_size_1_with_immutable_keys_and_values_is_immutable()
	{
		Method method = Helper.getCurrentMethod();
	...
	@Test public void map_of_size_2_with_immutable_keys_and_values_is_immutable()
	{
		Method method = Helper.getCurrentMethod();
	...
	@Test public void map_of_size_1_with_a_mutable_key_is_actually_mutable()
	{
		Method method = Helper.getCurrentMethod();
	...
	@Test public void map_of_size_2_with_a_mutable_key_is_actually_mutable()
	{
		Method method = Helper.getCurrentMethod();
		ConcreteMapEntry<ArrayList<?>,String> mutableEntry = new ConcreteMapEntry<>( new ArrayList<>(), "" );
	...
	@Test public void map_of_size_3_with_a_mutable_key_is_actually_mutable()
	{
		Method method = Helper.getCurrentMethod();
		ConcreteMapEntry<ArrayList<?>,String> mutableEntry = new ConcreteMapEntry<>( new ArrayList<>(), "" );
	...
	@Test public void map_of_size_1_with_a_mutable_value_is_actually_mutable()
	{
		Method method = Helper.getCurrentMethod();
	...
	@Test public void map_of_size_2_with_a_mutable_value_is_actually_mutable()
	{
		Method method = Helper.getCurrentMethod();
	...
	@Test public void map_of_size_3_with_a_mutable_value_is_actually_mutable()
	{
		Method method = Helper.getCurrentMethod();
